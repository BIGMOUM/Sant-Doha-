...
class BundleGeneratorTest extends GeneratorTest
{
    public function testGenerateYaml()
    {
        ...
        $files = array(
            'FooBarBundle.php',
            'Controller/HomeController.php            'Resources/views/Default/index.html.twig',
        ...
        $content = file_get_contents($this->tmpDir.'/Foo/BarBundle/Controller/HomeController.php
